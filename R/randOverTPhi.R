#' Temporal and Relevance Biased Random Oversampling
#'
...
#' C.perc <- list(4)
#' overTPhi <- randOverTPhi(V10 ~ ., ds, C.perc=C.perc)
#' overTPhi.Bal <- randOverTPhi(V10 ~ ., ds, C.perc="balance")
#' overTPhi.Ext <- randOverTPhi(V10 ~ ., ds, C.perc="extreme")
#'
randOverTPhi <- function(form, dat, rel = "auto", thr.rel = 0.5,
